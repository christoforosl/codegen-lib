...
///************************************************************
/// Class autogenerated on 11-Jul-15 10:45:15 AM by ModelGenerator
    ...
    [TestMethod()] public void TestLoadAndSaveEmployee() {
		...
		try {
			...
			if (pdb.SelectFromObjectName != pdb.ManagedTableName) {
				...
				Assert.AreEqual(count, countFromSelectObject, "Count of records in managedTableName {0} and SelectFromObjectName {1} should be equal, as there needs to be exactly 1 to 1 match between records in managed table and selectFromObject.", pdb.ManagedTableName, pdb.SelectFromObjectName);
			}

...
//************************************************************
// 
// Class autogenerated on12-May-15 11:20:46 AM by ModelGenerator
...
namespace OracleMappers {
	...
	public class RegionDBMapper : DBMapper {
		...
		public override IDbCommand getUpdateDBCommand(IModelObject modelObj, string sql) {
			IRegion obj = (IRegion)modelObj;
			IDbCommand stmt = this.dbConn.getCommand(sql);
				stmt.Parameters.Add(this.dbConn.getParameter("@REGION_NAME",obj.PrRegionName));
	...
	public sealed class RegionDataUtils {
		...
		public static Region loadFromDataRow(DataRow r) {
			...
			IModelObject mo = RegionFactory.Create();
			a.DataSource = r;
			a.load(mo);
			return (Region)mo;

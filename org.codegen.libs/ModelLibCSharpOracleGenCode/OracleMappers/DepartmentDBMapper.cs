...
//************************************************************
// 
// Class autogenerated on17-Jun-15 5:56:06 PM by ModelGenerator
...
namespace OracleMappers {
	...
	public class DepartmentDBMapper : DBMapper {
		...
		public override IDbCommand getUpdateDBCommand(IModelObject modelObj, string sql) {
			...
			if (obj.isNew){
				stmt.Parameters.Add(this.dbConn.getParameterInOut(Department.STR_FLD_DEPARTMENT_ID));
			} else {

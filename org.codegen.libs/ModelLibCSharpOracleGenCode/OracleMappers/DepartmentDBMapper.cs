...
//************************************************************
// 
// Class autogenerated on12-May-15 11:20:42 AM by ModelGenerator
...
namespace OracleMappers {
	...
	public class DepartmentDBMapper : DBMapper {
		...
		public override IDbCommand getUpdateDBCommand(IModelObject modelObj, string sql) {
			IDepartment obj = (IDepartment)modelObj;
			IDbCommand stmt = this.dbConn.getCommand(sql);
				stmt.Parameters.Add(this.dbConn.getParameter("@DEPARTMENT_NAME",obj.PrDepartmentName));
	...
	public sealed class DepartmentDataUtils {
		...
		public static Department loadFromDataRow(DataRow r) {
			...
			IModelObject mo = DepartmentFactory.Create();
			a.DataSource = r;
			a.load(mo);

...
//************************************************************
// 
// Class autogenerated on19-Dec-17 9:38:00 AM by ModelGenerator
...
namespace OracleMappers {
	...
	[SelectObject("COUNTRIES")][KeyFieldName("COUNTRY_ID")]
	public class CountryDBMapper : OracleDBMapper {
		...
		public override IDbCommand getUpdateDBCommand(IModelObject modelObj, string sql) {
			...
			stmt.Parameters.Add(this.dbConn.getParameter(Country.STR_FLD_IS_ACTIVE,obj.PrIsActive));
		...
		///	<returns> A List(Of Country) object containing all objects loaded </returns>
		///	 
		public List<Country> findList(string sWhereClause, List<IDataParameter> @params) {
	...
	public class CountryDataReaderLoader : DataReaderLoader {
		public override void load(IModelObject mo) {
			...
			const int DATAREADER_FLD_IS_ACTIVE = 6;
			...
			if (!this.reader.IsDBNull(DATAREADER_FLD_REGION_ID) ) {
				obj.PrRegionId = Convert.ToInt64(this.reader.GetInt32(DATAREADER_FLD_REGION_ID));
			}
			...
			if (!this.reader.IsDBNull(DATAREADER_FLD_IS_ACTIVE) ) {
				obj.PrIsActive = Convert.ToInt64(this.reader.GetInt16(DATAREADER_FLD_IS_ACTIVE));
			}

...
namespace OracleMappers {
	...
	[SelectObject("LOCATIONS")][KeyFieldName("LOCATION_ID")]
	public class LocationDBMapper : OracleDBMapper {
		...
		public override IDbCommand getUpdateDBCommand(IModelObject modelObj, string sql) {
			...
			stmt.Parameters.Add(this.dbConn.getParameter(Location.STR_FLD_STREET_ADDRESS,obj.PrStreetAddress));
			stmt.Parameters.Add(this.dbConn.getParameter(Location.STR_FLD_POSTAL_CODE,obj.PrPostalCode));
			stmt.Parameters.Add(this.dbConn.getParameter(Location.STR_FLD_CITY,obj.PrCITY));
			stmt.Parameters.Add(this.dbConn.getParameter(Location.STR_FLD_STATE_PROVINCE,obj.PrStateProvince));
			stmt.Parameters.Add(this.dbConn.getParameter(Location.STR_FLD_COUNTRY_ID,obj.PrCountryId));
			stmt.Parameters.Add(this.dbConn.getParameter(Location.STR_FLD_CREATE_DATE,obj.CreateDate));
			stmt.Parameters.Add(this.dbConn.getParameter(Location.STR_FLD_UPDATE_DATE,obj.UpdateDate));
			stmt.Parameters.Add(this.dbConn.getParameter(Location.STR_FLD_CREATE_USER,obj.CreateUser));
			stmt.Parameters.Add(this.dbConn.getParameter(Location.STR_FLD_UPDATE_USER,obj.UpdateUser));

			if (obj.isNew){
				IDataParameter prm = this.dbConn.getParameterInOut(Location.STR_FLD_LOCATION_ID);
			...
			//only add primary key if we are updating and as the last parameter
				stmt.Parameters.Add(this.dbConn.getParameter(Location.STR_FLD_LOCATION_ID,obj.PrLocationId));
			}
		...
		///	 <returns> A List(Of Location) object containing all objects loaded </returns>
		///	 
		public new List<Location> findList(string sWhereClause, List<IDataParameter> @params) {
	...
	public sealed class LocationDataUtils {
		...
		public static List<Location> findList(string @where, List<IDataParameter> listOfIParams) {

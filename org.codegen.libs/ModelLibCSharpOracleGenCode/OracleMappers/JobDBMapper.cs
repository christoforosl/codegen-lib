...
//************************************************************
// 
// Class autogenerated on12-May-15 11:20:44 AM by ModelGenerator
...
[AttrIsPrimaryKeyAutogenerated(false)]
	public class JobDBMapper : DBMapper {
		...
		public override IDbCommand getUpdateDBCommand(IModelObject modelObj, string sql) {
			IJob obj = (IJob)modelObj;
			IDbCommand stmt = this.dbConn.getCommand(sql);
				stmt.Parameters.Add(this.dbConn.getParameter("@JOB_TITLE",obj.PrJobTitle));
				stmt.Parameters.Add(this.dbConn.getParameter("@MIN_SALARY",obj.PrMinSalary));
				stmt.Parameters.Add(this.dbConn.getParameter("@MAX_SALARY",obj.PrMaxSalary));
...
;
	...
	public class JobDataReaderLoader : DataReaderLoader {
		public override void load(IModelObject mo) {
			...
			if (!this.reader.IsDBNull(DATAREADER_FLD_MIN_SALARY) ) {
				obj.PrMinSalary = this.reader.GetInt64(DATAREADER_FLD_MIN_SALARY);
			}
			if (!this.reader.IsDBNull(DATAREADER_FLD_MAX_SALARY) ) {
				obj.PrMaxSalary = this.reader.GetInt64(DATAREADER_FLD_MAX_SALARY);
			}
	...
	public sealed class JobDataUtils {
		...
		public static Job loadFromDataRow(DataRow r) {
			...
			IModelObject mo = JobFactory.Create();
			a.DataSource = r;
			a.load(mo);
			return (Job)mo;

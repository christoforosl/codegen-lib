...
//************************************************************
// 
// Class autogenerated on12-May-15 11:20:47 AM by ModelGenerator
...
[AttrIsPrimaryKeyAutogenerated(false)]
	public class TrainingCourseDBMapper : DBMapper {
		...
		public override IDbCommand getUpdateDBCommand(IModelObject modelObj, string sql) {
			ITrainingCourse obj = (ITrainingCourse)modelObj;
			IDbCommand stmt = this.dbConn.getCommand(sql);
				stmt.Parameters.Add(this.dbConn.getParameter("@DESCR_GR",obj.PrDescrGr));
				stmt.Parameters.Add(this.dbConn.getParameter("@DESCR_EN",obj.PrDescrEn));

			if ( obj.isNew ) {
			//pk is not autogenerated, add primary key if we are inserting...
							stmt.Parameters.Add(this.dbConn.getParameter("@CODE",obj.PrCODE));
;
			} else {
		...
		{
			return TrainingCourseFactory.Create();
		}
	...
	public sealed class TrainingCourseDataUtils {
		...
		public static void saveTrainingCourse(DataRow dr, ref TrainingCourse mo) {
			if (mo == null) {
				mo = TrainingCourseFactory.Create();
			}
		...
		public static TrainingCourse loadFromDataRow(DataRow r) {
			...
			IModelObject mo = TrainingCourseFactory.Create();
			a.DataSource = r;
			a.load(mo);

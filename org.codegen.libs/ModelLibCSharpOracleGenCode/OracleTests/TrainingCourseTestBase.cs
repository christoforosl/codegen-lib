...
///************************************************************
/// Class autogenerated on 23-Jul-15 12:28:42 PM by ModelGenerator
		...
		try {
			...
			if (count == 0) {
				...
				using (DataContext ctx = DBUtils.Current().dbContext()) {
					...
					var query = ctx.ExecuteQuery<TrainingCourse>(@"SELECT * FROM " + pdb.SelectFromObjectName ).Skip(1).Take(1);
				...
				**/
				...
				System.IO.FileInfo jf = new System.IO.FileInfo(".\\TrainingCourse.json");

...
///************************************************************
/// Class autogenerated on 5/16/2015 7:34:51 AM by ModelGenerator
...
#region "Additional test attributes"
    ...
    [TestMethod()] public void TestLoadAndSaveJobHistory() {
		...
		try {
			...
			object pid  = ModelContext.CurrentDBUtils.getIntValue("select top 1 JOB_HISTORY_ID from JOB_HISTORY");
			if (pid == 0) {

...
///************************************************************
/// Class autogenerated on 5/16/2015 7:34:49 AM by ModelGenerator
...
#region "Additional test attributes"
    ...
    [TestMethod()] public void TestLoadAndSaveEmployeeTrainingHistory() {
		...
		try {
			...
			object pid  = ModelContext.CurrentDBUtils.getIntValue("select top 1 EMPLOYEE_TRAINING_HISTORY_ID from EMPLOYEE_TRAINING_HISTORY");
			if (pid == 0) {

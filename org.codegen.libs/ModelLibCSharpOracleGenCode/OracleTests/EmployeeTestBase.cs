...
///************************************************************
/// Class autogenerated on 5/16/2015 7:34:50 AM by ModelGenerator
...
#region "Additional test attributes"
    ...
    [TestMethod()] public void TestLoadAndSaveEmployee() {
		...
		try {
			...
			object pid  = ModelContext.CurrentDBUtils.getIntValue("select top 1 EMPLOYEE_ID from EMPLOYEES");
			if (pid == 0) {

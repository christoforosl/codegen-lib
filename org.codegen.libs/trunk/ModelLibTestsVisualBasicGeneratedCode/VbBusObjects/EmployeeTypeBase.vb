...
' Class autogenerated on 13-04-2015 12:14:07 by ModelGenerator
...
<System.Runtime.InteropServices.ComVisible(False)> _
	...
	Property EmployeeType as System.String
End Interface
#End region 
...
#Region "Field Declarations"
	...
	Private _EmployeeType as System.String = Nothing
...
#Region "Field Properties"
	...
	Public Overridable Property EmployeeTypeCode as System.String _ 
		Implements IEmployeeType.EmployeeTypeCode
	Get 
...
Public Sub setEmployeeTypeCode(ByVal val As String)
	...
	End If
End Sub
	Public Overridable Property EmployeeType as System.String _ 
		Implements IEmployeeType.EmployeeType
	Get 
	...
	End Set 
	End Property 
Public Sub setEmployeeType(ByVal val As String)
	If not String.isNullOrEmpty(val) Then
		Me.EmployeeType = val
	Else
		Me.EmployeeType = Nothing
	End If
End Sub
    ...
    Public Overloads Overrides Sub setAttribute(ByVal fieldKey As Integer, ByVal val As Object)
		...
		case FLD_EMPLOYEETYPE
			If Val Is DBNull.Value OrElse Val Is Nothing Then
				Me.EmployeeType = Nothing
			Else
				Me.EmployeeType=CType(val,System.String)
			End If
			return
		case else
			return
...
#Region "Overrides of GetHashCode and Equals "
	Public Overloads Function Equals(ByVal other As EmployeeTypeBase) As Boolean _     
		Implements System.IEquatable(Of EmployeeTypeBase).Equals       
			...
			Return me.EmployeeTypeCode= other.EmployeeTypeCode _
				AndAlso me.EmployeeType= other.EmployeeType
				
	End Function
	
	Public Overrides Function GetHashCode() As Integer
        'using Xor has the advantage of not overflowing the integer.
        Return me.getStringHashCode(Me.EmployeeTypeCode) _
				Xor me.getStringHashCode(Me.EmployeeType) 
...
#Region "Copy and sort"
	...
	Public Overrides Function copy() as IModelObject
		...
		ret.EmployeeType = me.EmployeeType
	...
	Public Overrides Sub merge(other as IModelObject)
		...
		Dim o as EmployeeType = CType(other, EmployeeType)
		If not String.isNullOrEmpty(o.EmployeeType) AndAlso _
		 String.isNullOrEmpty(me.EmployeeType) Then 
		me.EmployeeType = o.EmployeeType
End If
...
#Region "Req Fields validator"
    ...
    Public Class EmployeeTypeRequiredFieldsValidator
        ...
        Public Sub validate(ByVal imo As org.model.lib.Model.IModelObject) _
			...
			if String.isNullOrEmpty( mo.EmployeeType) Then

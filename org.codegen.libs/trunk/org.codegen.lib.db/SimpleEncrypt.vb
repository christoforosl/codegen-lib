...
#Region "  Utils"
    ...
    Friend Class Utils
        ...
        Friend Shared Function GetConfigString(ByVal key As String, _
            ...
            Dim s As String = CType(System.Configuration.ConfigurationManager.AppSettings.Get(key), String)
            If s = Nothing Then
                If isRequired Then
                    Throw New ApplicationException("key <" & key & "> is missing from .config file")
                Else
                    Return ""
                End If
            Else

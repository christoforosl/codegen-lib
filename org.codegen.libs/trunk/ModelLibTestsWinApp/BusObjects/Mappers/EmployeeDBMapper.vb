...
'<comments>
'************************************************************
' Class autogenerated on 01/04/2013 7:45:17 PM by ModelGenerator
...
#Region "Shared ""get"" Functions "
        ...
        ''' </summary>
        ''' <remarks>use this method when you want to relad the Employee from the database, discarding any changes</remarks>
		Public Shared Sub reload(ByVal mo As Employee)

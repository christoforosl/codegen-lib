...
#Region "Overloaded Functions"
        ...
        Public Shadows Function findByKey(ByVal keyval As Integer) As EmployeeRank
...
#Region "getUpdateDBCommand"
        Public Overrides Function getUpdateDBCommand(ByVal modelObj As IModelObject, _
             ...
             Dim obj as IEmployeeRank = DirectCast(modelObj,IEmployeeRank)
             Dim stmt As IDbCommand = Me.dbConn.getCommand(sql)


			stmt.Parameters.Add( Me.dbConn.getParameter("@Rank",obj.Rank))

			if obj.isNew = False then
			'only add primary key if we are updating and as the last parameter
							stmt.Parameters.Add( Me.dbConn.getParameter("@RankId",obj.RankId))
		end if
	...
	Public Class EmployeeRankDataReaderLoader
		Inherits DataReaderLoader
			...
			if me.reader.IsDBNull(DATAREADER_FLD_RANKID) = false Then
				obj.RankId = me.reader.getInt32(DATAREADER_FLD_RANKID)
			End if
			if me.reader.IsDBNull(DATAREADER_FLD_RANK) = false Then
				obj.Rank = me.reader.GetString(DATAREADER_FLD_RANK)
			End if
...
#Region "Shared ""get"" Functions "
        ...
        Public Shared Function findByKey(id as Integer) as EmployeeRank
        ...
        ''' </summary>
        ''' <remarks>use this method when you want to relad the EmployeeRank from the database, discarding any changes</remarks>
		Public Shared Sub reload(ByVal mo As EmployeeRank)
...
#Region "Data Table and data row load/save "        
        ...
        End Sub
		 ...
		 Public Shared Function loadFromDataRow(ByVal r As DataRow) As EmployeeRank
            ...
            Dim mo As IModelObject = EmployeeRankFactory.Create
            a.DataSource = r
            a.load(mo)

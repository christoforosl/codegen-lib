...
#Region "Shared ""get"" Functions "
        ...
        ''' </summary>
        ''' <remarks>use this method when you want to relad the EmployeeInfo from the database, discarding any changes</remarks>
		Public Shared Sub reload(ByVal mo As EmployeeInfo)

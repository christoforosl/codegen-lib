...
//************************************************************
// 
// Class autogenerated on14-04-2015 11:41:53 by ModelGenerator
...
#region "Save Children Code"
	public override void saveChildren(IModelObject mo) {
		...
		if (ret.EmployeeProjectsLoaded) {
			...
			employeeprojectsMapper.deleteList(ret.EmployeeProjectsGetDeleted());
		}
	}
#endregion
	...
	public class EmployeeDataReaderLoader : DataReaderLoader {
		public override void load(IModelObject mo) {
			...
			const int DATAREADER_FLD_CREATEDATE = 11;
			const int DATAREADER_FLD_UPDATEDATE = 12;
			const int DATAREADER_FLD_UPDATEUSER = 13;
			const int DATAREADER_FLD_CREATEUSER = 14;
			const int DATAREADER_FLD_EMPLOYEETYPECODE = 15;

...
'************************************************************
' Class autogenerated on 14/06/2015 8:19:54 AM by ModelGenerator
	...
	Public Class EmployeeEvaluationDataReaderLoader
		Inherits DataReaderLoader
			...
			if me.reader.IsDBNull(DATAREADER_FLD_EMPLOYEE_EVALUATION_ID) = false Then
				obj.PrEmployeeEvaluationId = me.reader.GetInt32(DATAREADER_FLD_EMPLOYEE_EVALUATION_ID)
			End if
			if me.reader.IsDBNull(DATAREADER_FLD_EVALUATOR_ID) = false Then
				obj.PrEvaluatorId = me.reader.GetInt32(DATAREADER_FLD_EVALUATOR_ID)
			End if
			...
			if me.reader.IsDBNull(DATAREADER_FLD_EMPLOYEE_ID) = false Then
				obj.PrEmployeeId = me.reader.GetInt32(DATAREADER_FLD_EMPLOYEE_ID)
			End if

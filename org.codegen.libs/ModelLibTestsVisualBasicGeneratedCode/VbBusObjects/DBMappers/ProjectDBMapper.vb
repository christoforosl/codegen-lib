...
'************************************************************
' Class autogenerated on 14-04-2015 10:35:56 by ModelGenerator
...
#Region "getUpdateDBCommand"
        Public Overrides Function getUpdateDBCommand(ByVal modelObj As IModelObject, _
			...
			stmt.Parameters.Add( Me.dbConn.getParameter("@ProjectName",obj.PrProjectName))
			...
			stmt.Parameters.Add( Me.dbConn.getParameter("@ProjectId",obj.PrProjectId))
	...
	Public Class ProjectDataReaderLoader
		Inherits DataReaderLoader
			...
			if me.reader.IsDBNull(DATAREADER_FLD_ISACTIVE) = false Then
				obj.PrIsActive = CType(me.reader.GetInt32(DATAREADER_FLD_ISACTIVE),System.Boolean)
			End if

...
'************************************************************
' Class autogenerated on 11-Jul-15 10:43:41 AM by ModelGenerator
...
Namespace VbBusObjects.DBMappers
	...
	<SelectObject("vEmployee")><KeyFieldName("EmployeeId")> _
...
#Region " Employee Loader "
	...
	Public Class EmployeeDataReaderLoader
		Inherits DataReaderLoader
			...
			Const DATAREADER_FLD_EMPLOYEETYPEDESCR as Integer = 22
			Const DATAREADER_FLD_RANKDESCR as Integer = 23
			...
			End if
			if me.reader.IsDBNull(DATAREADER_FLD_EMPLOYEETYPEDESCR) = false Then
				obj.PrEmployeeTypeDescr = me.reader.GetString(DATAREADER_FLD_EMPLOYEETYPEDESCR)
			End if
			if me.reader.IsDBNull(DATAREADER_FLD_RANKDESCR) = false Then
				obj.PrRankDescr = me.reader.GetString(DATAREADER_FLD_RANKDESCR)
			End if

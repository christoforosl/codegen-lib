...
' Class autogenerated on 21-Apr-15 3:28:02 PM by ModelGenerator
...
#Region "Field CONSTANTS"
        ...
        Public Overrides Function getFieldList() As String()
            Return New String() {STR_FLD_EMPLOYEEID,STR_FLD_EMPLOYEENAME,STR_FLD_EMPLOYEERANKID,STR_FLD_SALARY,STR_FLD_ADDRESS,STR_FLD_TELEPHONE,STR_FLD_MOBILE,STR_FLD_IDNUMBER,STR_FLD_SSINUMBER,STR_FLD_HIREDATE,STR_FLD_NUMDEPENDENTS,STR_FLD_EMPLOYEETYPECODE,STR_FLD_CREATEDATE,STR_FLD_UPDATEDATE,STR_FLD_CREATEUSER,STR_FLD_UPDATEUSER}
        End Function
...
End Sub
		...
		Public Overridable Function EmployeeProjectGetAt(ByVal i As Integer) As VbBusObjects.EmployeeProject _
				implements IEmployee.EmployeeProjectGetAt
		...
		Public Overridable Sub EmployeeProjectAdd(val As VbBusObjects.EmployeeProject) _
				implements IEmployee.EmployeeProjectAdd
		...
		Public Overridable Sub EmployeeProjectRemove( _ 
					...
					implements IEmployee.EmployeeProjectRemove
		...
		Public Overridable Function EmployeeProjectsGetDeleted() As IEnumerable(Of VbBusObjects.EmployeeProject) _
					implements IEmployee.EmployeeProjectsGetDeleted
...
#Region "Overrides of GetHashCode and Equals "
	Public Overloads Function Equals(ByVal other As EmployeeBase) As Boolean _     
		Implements System.IEquatable(Of EmployeeBase).Equals       
			...
			Return me.PrEmployeeId= other.PrEmployeeId _
				...
				AndAlso me.UpdateUser= other.UpdateUser
	...
	Public Overrides Function GetHashCode() As Integer
        ...
        Return me.PrEmployeeId.GetHashCode _
				...
				Xor me.getStringHashCode(Me.UpdateUser) 

...
' Class autogenerated on 11-Jun-15 2:55:27 PM by ModelGenerator
...
#Region "Field CONSTANTS"
			...
			public Const STR_FLD_CVFILECONTENT as String = "CvFileContent"
			public Const STR_FLD_PHOTO as String = "Photo"
		...
		public Const FLD_CVFILECONTENT as Integer = 22
		public Const FLD_PHOTO as Integer = 23
        ...
        Public Overrides Function getFieldList() As String()
            Return New String() {STR_FLD_EMPLOYEEID,STR_FLD_EMPLOYEENAME,STR_FLD_EMPLOYEERANKID,STR_FLD_SALARY,STR_FLD_ADDRESS,STR_FLD_TELEPHONE,STR_FLD_MOBILE,STR_FLD_IDNUMBER,STR_FLD_SSINUMBER,STR_FLD_HIREDATE,STR_FLD_NUMDEPENDENTS,STR_FLD_EMPLOYEETYPECODE,STR_FLD_CREATEDATE,STR_FLD_UPDATEDATE,STR_FLD_CREATEUSER,STR_FLD_UPDATEUSER,STR_FLD_SAMPLEGUIDFIELD,STR_FLD_ISACTIVE,STR_FLD_SAMPLEBIGINT,STR_FLD_SAMPLESMALLINT,STR_FLD_SAMPLENUMERICFIELDINT,STR_FLD_SAMPLENUMERICFIELD2DECIMALS,STR_FLD_CVFILECONTENT,STR_FLD_PHOTO}
        End Function
...
#Region "Field Declarations"
	...
	Private _CvFileContent as System.Byte()
...
<DataMember>	 Overridable Property PrEmployeeRankId as Nullable (of System.Int64)
	Get 
...
<DataMember>	 Overridable Property PrHireDate as Nullable (of System.DateTime)
	Get 
		return _HireDate
	End Get 
...
<DataMember>	 Overridable Property PrNumDependents as Nullable (of System.Int64)
	Get 
...
<DataMember>	 Overridable Property PrSampleGuidField as Nullable (of System.Guid)
	Get 
...
<DataMember>	 Overridable Property PrSampleBigInt as Nullable (of System.Int64)
	Get 
...
<DataMember>	 Overridable Property PrSampleSmallInt as Nullable (of System.Int64)
	Get 
...
<DataMember>	 Overridable Property PrSampleNumericFieldInt as Nullable (of System.Int64)
	Get 
...
<DataMember>	 Overridable Property PrSampleNumericField2Decimals as Nullable (of System.Decimal)
	Get 
	...
	End Set 
	End Property 
	<Column(Name:="CvFileContent",Storage:="_CvFileContent", IsPrimaryKey:=False,DbType:="varbinary",CanBeNull:=True )> _
<DataMember>	 Overridable Property PrCvFileContent as System.Byte()
	Get 
		return _CvFileContent
	End Get 
	Set(ByVal value As System.Byte())
		if ModelObject.valueChanged(_CvFileContent, value) then
			if me.IsObjectLoading = false then
				me.isDirty = true
				me.setFieldChanged(STR_FLD_CVFILECONTENT)
			End If
			me._CvFileContent=value

		End if
	End Set 
	End Property 
	<Column(Name:="photo",Storage:="_Photo", IsPrimaryKey:=False,DbType:="varbinary",CanBeNull:=True )> _
<DataMember>	 Overridable Property PrPhoto as System.Byte()
	Get 
		return _Photo
	End Get 
	Set(ByVal value As System.Byte())
		if ModelObject.valueChanged(_Photo, value) then
			if me.IsObjectLoading = false then
				me.isDirty = true
				me.setFieldChanged(STR_FLD_PHOTO)
			End If
			me._Photo=value
...
#Region "Getters/Setters of values by field index/name"
    ...
    Public Overloads Overrides Function getAttribute(ByVal fieldKey As String) As Object
		...
		if fieldKey=STR_FLD_EMPLOYEEID.ToLower() Then
			...
			return me.PrSampleNumericField2Decimals
		else if fieldKey=STR_FLD_CVFILECONTENT.ToLower() Then
			return me.PrCvFileContent
		else if fieldKey=STR_FLD_PHOTO.ToLower() Then
			return me.PrPhoto
		else
			return nothing
		end If
    ...
    Public Overloads Overrides Sub setAttribute(ByVal fieldKey As Integer, ByVal val As Object)
		...
		case FLD_CVFILECONTENT
			If Val Is DBNull.Value OrElse Val Is Nothing Then
				Me.PrCvFileContent = Nothing
			Else
				Me.PrCvFileContent=CType(val,System.Byte())
			End If
			return
		case FLD_PHOTO
			If Val Is DBNull.Value OrElse Val Is Nothing Then
				Me.PrPhoto = Nothing
			Else
				Me.PrPhoto=CType(val,System.Byte())
			End If
			return
		case else
			return
...
#Region "Copy and sort"
	...
	Public Overrides Function copy() as IModelObject
		...
		ret.PrCvFileContent = me.PrCvFileContent
		ret.PrPhoto = me.PrPhoto

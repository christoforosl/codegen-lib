...
' Class autogenerated on 06-Sep-15 11:44:05 AM by ModelGenerator
...
<Table(Name := "EmployeeProject")><SelectObject("EmployeeProject")><KeyFieldName("EmployeeProjectId")> _
...
#Region "Children and Parents"
	...
	Public Overrides Function getParents() As List(Of ModelObject)
		Dim ret as New List(Of ModelObject)()
		if  Me._Project isNot Nothing AndAlso Me.ProjectLoaded Then
		...
		if ModelObject.valueChanged(_EPProjectId, value) then
			if me.IsObjectLoading = false then
				...
				me.setFieldChanged(STR_FLD_EPPROJECTID)
						me._Project= nothing ' reset if id of parent object has changed
						me.ProjectLoaded= false
			End If
...
<DataMember>	 Overridable Property PrRate as System.Decimal?
	...
	End Property 
		...
		<DataMember>
		friend ProjectLoaded as Boolean

		''' <summary>
        ''' Gets/Sets parent object PrProject
        ''' </summary>
        ...
        ''' </summary>x
        private Sub LoadPrProject
			
			If me.ProjectLoaded then return

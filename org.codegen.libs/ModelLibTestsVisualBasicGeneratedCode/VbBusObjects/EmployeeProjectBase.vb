...
' Class autogenerated on 14-04-2015 10:58:51 by ModelGenerator
...
#Region "Copy and sort"
	...
	Public Overrides Sub merge(other as IModelObject)
		...
		If not o.PrEPEmployeeId is Nothing AndAlso _
		 me.PrEPEmployeeId is Nothing Then 
		me.PrEPEmployeeId = o.PrEPEmployeeId
End If
If not o.PrEPProjectId is Nothing AndAlso _
		 me.PrEPProjectId is Nothing Then 
		me.PrEPProjectId = o.PrEPProjectId
End If
If not o.PrAssignDate is Nothing AndAlso _
		 me.PrAssignDate is Nothing Then 
		me.PrAssignDate = o.PrAssignDate
End If
If not o.PrEndDate is Nothing AndAlso _
		 me.PrEndDate is Nothing Then 
		me.PrEndDate = o.PrEndDate
End If
If not o.PrRate is Nothing AndAlso _
		 me.PrRate is Nothing Then 
		me.PrRate = o.PrRate
End If

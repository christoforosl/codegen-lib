...
#End Region
    ...
    <TestMethod()> Public Sub TestLoadAndSaveTestTableNoIncrement()
		
		ModelContext.beginTrans()
		Try

			Dim pdb As New TestTableNoIncrementDBMapper()
			...
			Else
				...
				Dim p As TestTableNoIncrement = pdb.findByKey(pid)
				Dim p2 As TestTableNoIncrement = directCast(p.copy(),TestTableNoIncrement)
				...
				p = ModelContext.Current.loadModelObject(Of TestTableNoIncrement)(p.Id)
				...
				Dim jf As New System.IO.FileInfo(".\TestTableNoIncrement.json")

...
#End Region
    ...
    <TestMethod()> Public Sub TestLoadAndSaveEmployeeInfo()
		...
		Try
			...
			Dim pid As Object = ModelContext.CurrentDBUtils.getObjectValue("select top 1 EmployeeInfoId from EmployeeInfo")
			...
			Else
				...
				'test fields to be equal before and after save
						Assert.IsTrue(p.PrEmployeeInfoId = p2.PrEmployeeInfoId,"Expected Field PrEmployeeInfoId to be equal")
		Assert.IsTrue(p.PrEIEmployeeId.GetValueOrDefault = p2.PrEIEmployeeId.GetValueOrDefault,"Expected Field PrEIEmployeeId to be equal")

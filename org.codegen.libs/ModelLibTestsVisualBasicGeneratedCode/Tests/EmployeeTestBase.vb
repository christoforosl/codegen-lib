...
#End Region
    ...
    <TestMethod()> Public Sub TestLoadAndSaveEmployee()
		...
		'skip update user!
		Assert.IsTrue(p.SampleGuidField.GetValueOrDefault = p2.SampleGuidField.GetValueOrDefault,"Expected Field SampleGuidField to be equal")
		Assert.IsTrue(p.IsActive = p2.IsActive,"Expected Field IsActive to be equal")
		Assert.IsTrue(p.SampleBigInt.GetValueOrDefault = p2.SampleBigInt.GetValueOrDefault,"Expected Field SampleBigInt to be equal")
		Assert.IsTrue(p.SampleSmallInt.GetValueOrDefault = p2.SampleSmallInt.GetValueOrDefault,"Expected Field SampleSmallInt to be equal")
		Assert.IsTrue(p.SampleNumericFieldInt.GetValueOrDefault = p2.SampleNumericFieldInt.GetValueOrDefault,"Expected Field SampleNumericFieldInt to be equal")
		Assert.IsTrue(p.SampleNumericField2Decimals.GetValueOrDefault = p2.SampleNumericField2Decimals.GetValueOrDefault,"Expected Field SampleNumericField2Decimals to be equal")

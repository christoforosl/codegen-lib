    ...
    <TestMethod()> Public Sub TestLoadAndSaveEmployee()
        ...
        Try
            ...
            Else
                ...
                ' skip binary files!
                ' skip binary files!
                Assert.IsTrue(p.PrEmployeeTypeDescr = p2.PrEmployeeTypeDescr, "Expected Field PrEmployeeTypeDescr to be equal")
                Assert.IsTrue(p.PrRankDescr = p2.PrRankDescr, "Expected Field PrRankDescr to be equal")

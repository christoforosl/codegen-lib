...
'************************************************************
' Class autogenerated on 15-May-15 11:50:10 AM by ModelGenerator
...
#End Region
    ...
    <TestMethod()> Public Sub TestLoadAndSaveEmployeeType()
		...
		Try
			...
			Dim pid As long = ModelContext.CurrentDBUtils.getIntValue("select top 1 EmployeeTypeCode from EmployeeType")
			If pid = 0 Then

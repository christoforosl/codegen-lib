...
#End Region
    ...
    <TestMethod()> Public Sub TestLoadAndSaveAccount()
		...
		Try
			...
			Else
				Dim pid As Object = ModelContext.CurrentDBUtils.getObjectValue("select top 1 accountid from Account")
				...
				'test fields to be equal before and after save
						Assert.IsTrue(p.PrAccountid = p2.PrAccountid,"Expected Field PrAccountid to be equal")
		Assert.IsTrue(p.PrAccount = p2.PrAccount,"Expected Field PrAccount to be equal")
		Assert.IsTrue(p.PrAccountTypeid.GetValueOrDefault = p2.PrAccountTypeid.GetValueOrDefault,"Expected Field PrAccountTypeid to be equal")
		Assert.IsTrue(p.PrBankaccnumber = p2.PrBankaccnumber,"Expected Field PrBankaccnumber to be equal")
		Assert.IsTrue(p.PrNextCheckNumber = p2.PrNextCheckNumber,"Expected Field PrNextCheckNumber to be equal")
		Assert.IsTrue(p.PrDescription = p2.PrDescription,"Expected Field PrDescription to be equal")

...
namespace CsModelMappers {
	...
	[System.Runtime.InteropServices.ComVisible(false)][SelectObject("Project")][KeyFieldName("ProjectId")]
...
#region "Save Children Code"
	public override void saveChildren(IModelObject mo) {
		...
		///	 <returns> A List(Of Project) object containing all objects loaded </returns>
		///	 
		public new List<Project> findList(string sWhereClause, List<IDataParameter> @params) {

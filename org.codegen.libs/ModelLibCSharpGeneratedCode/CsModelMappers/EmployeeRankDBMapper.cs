...
namespace CsModelMappers {
	...
	[System.Runtime.InteropServices.ComVisible(false)][SelectObject("EmployeeRank")][KeyFieldName("RankId")]
	public class EmployeeRankDBMapper : DBMapper {
		...
		///	 <returns> A List(Of EmployeeRank) object containing all objects loaded </returns>
		///	 
		public new List<EmployeeRank> findList(string sWhereClause, List<IDataParameter> @params) {
	...
	public sealed class EmployeeRankDataUtils {
		...
		public static List<EmployeeRank> findList(string @where, List<IDataParameter> listOfIParams) {

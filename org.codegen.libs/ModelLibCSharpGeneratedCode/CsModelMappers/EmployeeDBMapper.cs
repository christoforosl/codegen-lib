...
//************************************************************
// 
// Class autogenerated on11/07/2015 9:28:03 AM by ModelGenerator
...
namespace CsModelMappers {
	...
	[System.Runtime.InteropServices.ComVisible(false)][SelectObject("Employee")][KeyFieldName("EmployeeId")]
...
#region "Save Children Code"
	...
	public override void saveParents(IModelObject mo ){
		...
		///	 <returns> A List(Of Employee) object containing all objects loaded </returns>
		///	 
		public new List<Employee> findList(string sWhereClause, List<IDataParameter> @params) {

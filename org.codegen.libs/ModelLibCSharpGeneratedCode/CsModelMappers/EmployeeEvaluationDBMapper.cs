...
namespace CsModelMappers {
	...
	[System.Runtime.InteropServices.ComVisible(false)][SelectObject("Employee_Evaluation")][KeyFieldName("Employee_Evaluation_Id")]
	public class EmployeeEvaluationDBMapper : DBMapper {
		...
		///	 <returns> A List(Of EmployeeEvaluation) object containing all objects loaded </returns>
		///	 
		public new List<EmployeeEvaluation> findList(string sWhereClause, List<IDataParameter> @params) {

...
[AttrIsPrimaryKeyAutogenerated(false)][SelectObject("EmployeeType")][KeyFieldName("EmployeeTypeCode")]
	public class EmployeeTypeDBMapper : DBMapper {
		...
		///	 <returns> A List(Of EmployeeType) object containing all objects loaded </returns>
		///	 
		public new List<EmployeeType> findList(string sWhereClause, List<IDataParameter> @params) {

...
Public Class FileGroupLoader
    ...
    Public Function loadFileGroups(ByVal obj As IObjectToGenerate) As Dictionary(Of String, IGeneratedFileComponent) Implements IFileGroupLoader.loadFileGroups
        ...
        If ModelGenerator.Current.dotNetLanguage = ModelGenerator.enumLanguage.VB Then
            moClassBase.templateFileName = "org.codegen.lib.ModelBase2.visualBasic.txt"
        Else
            moClassBase.templateFileName = "org.codegen.lib.ModelBase2.csharp.txt"
        ...
        If ModelGenerator.Current.dotNetLanguage = ModelGenerator.enumLanguage.VB Then
            moClass.templateFileName = "org.codegen.lib.ModelBaseExtender2.visualBasic.txt"
        Else
            moClass.templateFileName = "org.codegen.lib.ModelBaseExtender2.csharp.txt"
        End If
        ...
        If obj.GenerateMapper Then
            ...
            If ModelGenerator.Current.dotNetLanguage = ModelGenerator.enumLanguage.VB Then
                mapperBaseClass.templateFileName = "org.codegen.lib.DBMapperBase.visualBasic.txt"
            Else
                mapperBaseClass.templateFileName = "org.codegen.lib.DBMapperBase.csharp.txt"
            End If
            ...
            sqlFile.templateFileName = "org.codegen.lib.SqlTemplate.txt"
        ...
        If String.IsNullOrEmpty(ModelGenerator.Current.ProjectOutputDirTest) = False Then
            ...
            If ModelGenerator.Current.dotNetLanguage = ModelGenerator.enumLanguage.VB Then
                testClass.templateFileName = "org.codegen.lib.TestTemplate.visualbasic.txt"
            Else
                testClass.templateFileName = "org.codegen.lib.TestTemplate.csharp.txt"
            End If

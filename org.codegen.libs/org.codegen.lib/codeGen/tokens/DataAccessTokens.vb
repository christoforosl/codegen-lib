        ...
        Public Overrides Function getReplacementCodeCSharp(t As IObjectToGenerate) As String
            ...
            Else
                ...
                If ModelGenerator.Current.DbConnStringDialect = DBUtils.enumSqlDialect.ORACLE Then
                    ...
                    ret.Append(String.Format("stmt.Parameters.Add(this.dbConn.getParameterInOut({0}.{1}));", CType(t, ObjectToGenerate).ClassName, t.DbTable.getPrimaryKeyField.getConstantStr))
                    ret.Append(vbCrLf)
                End If

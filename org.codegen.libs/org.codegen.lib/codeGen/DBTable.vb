...
Public Class DBTable
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property Associations() As List(Of Association) = New List(Of Association) Implements IDBTable.Associations

    Private _isPrimaryKeyAutogenerated As Boolean
    ...
    Public Overridable Sub addAssociation(ByVal n As Association) Implements IDBTable.addAssociation
        If n.isParent() Then
    ...
    Private Sub loadFields()
        ...
        Try
            ...
            If Me.getPrimaryKeyField.isString Then
                Me.isPrimaryKeyAutogenerated = False
            End If
    ...
    Private Function extractFieldsFromMetadata(ByVal rs As IDataReader) As Dictionary(Of String, IDBField)
        ...
        For i As Integer = 0 To numberOfColumns - 1
            ...
            If (dr.Table.Columns.Item("DataTypeName") IsNot Nothing) Then

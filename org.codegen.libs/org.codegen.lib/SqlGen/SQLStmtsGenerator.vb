...
Public Class SQLStmtsGenerator
    ...
    Protected Friend Overridable Function getSelectStatement(ByVal forpkey As Boolean) As String
        ...
        sb.Append(String.Join(",", sfields)).Append(" FROM " & Me.dbTable.SelectObject)
    ...
    Public Overridable Function insertStatementOracle() As String
        ...
        If Me.dbTable.isPrimaryKeyAutogenerated Then
            sbfields.Append(") values (")
            sbvalues.Append(") RETURNING " & Me.dbTable.getPrimaryKeyName() & " INTO ?;END;")
        Else
            sbfields.Append(",").Append(Me.dbTable.getPrimaryKeyName()).Append(") values (")
        ...
        If Me.dbTable.isPrimaryKeyAutogenerated Then
            sbfields.Insert(0, "BEGIN insert into " & Me.dbTable.quotedTableName() & " (")
        Else
            sbfields.Insert(0, "insert into " & Me.dbTable.quotedTableName() & " (")
        End If

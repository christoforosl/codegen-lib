...
''' 
Public Class DBMapper(Of T As {ModelObject, New})
...
#Region "Persistence"
    ...
    Public Overridable Sub delete(ByVal mo As T)
        ...
        For Each imof As T In mo.getChildren()
            Me.delete(imof)
        Next
        'End If
    ...
    Public Overridable Sub insert(ByVal mo As T)
        ...
        Try
            ...
            If Me._isPrimaryKeyAutogenerated Then
                ...
                mo.Id = Me.dbConn.getLastIdentity()
            End If
...
#Region "Object Loader"
    ...
    Public MustOverride Property Loader() As IModelObjectLoader

...
Namespace Forms.List
    ...
    Public Class frmEditableProjectList
...
#Region "Standard Code"
        ...
        Private Sub frmProjectList_Load(ByVal sender As Object, ByVal e As System.EventArgs) _
           Handles Me.Load
            ...
            Me.grdData.loadGrid()
            Me.grdData.setEditable(New ProjectDBMapper)

            Me.grdData.Columns(1).ReadOnly = False
            Me.grdData.Columns(2).ReadOnly = False
        ...
        Protected Sub DeleteRecordConfirmed(ByVal sender As System.Object) Handles Me.gridDeleteRecordConfirmed
            ...
            Dim mo As Project = m.findByKey(gridsender.IdValue)
            Call m.delete(mo)

...
#Region "Field CONSTANTS"
		...
		public Const FLD_TELEPHONE as Integer = 4
		public Const FLD_MOBILE as Integer = 5
		public Const FLD_IDNUMBER as Integer = 6
		public Const FLD_SSINUMBER as Integer = 7
		public Const FLD_HIREDATE as Integer = 8
		public Const FLD_NUMDEPENDENTS as Integer = 9
        ...
        Public Overrides Function getFieldList() As String()
            Return New String() {STR_FLD_EMPLOYEEID,STR_FLD_EMPLOYEENAME,STR_FLD_EMPLOYEERANKID,STR_FLD_ADDRESS,STR_FLD_TELEPHONE,STR_FLD_MOBILE,STR_FLD_IDNUMBER,STR_FLD_SSINUMBER,STR_FLD_HIREDATE,STR_FLD_NUMDEPENDENTS}
        End Function
...
End Sub
	...
	End Function 
        ...
        ''' <summary>
        ''' Loads child/parent object and sets 
        ...
        Public Overridable Sub loadRank
			...
			If Me._Rank Is Nothing AndAlso _
                ...
                Me._Rank = new BusObjects.Mappers.EmployeeRankDBMapper().FindByKey( _ 
				                 Me.EmployeeRankId.Value)
                
            End If ' me._Rank is Nothing

            If Me._Rank Is Nothing Then
                Me._Rank = BusObjects.EmployeeRankFactory.Create()
	...
	End Function 
        ...
        Public Overridable Sub loadEmployeeInfo
            ...
            If Me._EmployeeInfo Is Nothing Then
                Me._EmployeeInfo = BusObjects.EmployeeInfoFactory.Create()
                Me._EmployeeInfo.EIEmployeeId = me.EmployeeId
	...
	End Function 
			...
			Set(value as IEnumerable(Of BusObjects.EmployeeProject))
                ...
                Else
                    ...
                    While value.GetEnumerator.MoveNext
                        Me._EmployeeProjects.Add(value.GetEnumerator.Current)
                    End While
                End If
			End Set
        ...
        Public Overridable Sub loadEmployeeProjects
			...
			If Me.isNew Then
                Me._EmployeeProjects = New List(Of BusObjects.EmployeeProject)
            Else
                Me._EmployeeProjects = new BusObjects.Mappers.EmployeeProjectDBMapper().findList( _ 
        ...
        ''' resets the child object to force reload from database
        ''' </summary>
        Public Overridable Sub resetEmployeeProjects
			
			me.EmployeeProjects=nothing

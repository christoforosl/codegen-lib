...
'<comments>
'************************************************************
' Class autogenerated on 23/09/2011 9:51:38 PM by ModelGenerator
...
#Region "Shared ""get"" Functions "
        ...
        Public Shared Function findByKey(id as Integer) as Project
			...
			Dim ret as Project = Nothing
			Dim dbm as ProjectDBMapper = new ProjectDBMapper()
			ret = DirectCast(dbm.findByKey(id),Project)
